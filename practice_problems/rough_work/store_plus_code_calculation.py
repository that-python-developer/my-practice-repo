...
if __name__ == '__main__':
    ...
    python_process_name = 'store_plus_code_calculation'
    ...
    schema_name = 'edw_tab'
    table_name = 'dw_dim_store'
    stg_table_name = 'stg_store_lat_long_to_plus_code'
    ...
    result_df['store_geo_plus_code'] = None

    for i, row in result_df.iterrows():
        try:
            person_id = row['store_code']
            latitude = row['latitude']
            longitude = row['longitude']
            row['store_geo_plus_code'] = encode(float(latitude), float(longitude))
